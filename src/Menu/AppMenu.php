...
final class AppMenu implements KnpMenuHelperInterface
{
    ...
    public function navbarMenu(KnpMenuEvent $event): void
    {
        ...
        $this->add($menu,MeiliDashboardController::MEILI_DASHBOARD_ROUTE . "_asset_index",label: "Asset");
        //$this->add($menu, 'app_thumbs');
        $this->add($menu, MeiliDashboardController::MEILI_DASHBOARD_ROUTE . '_variant_index', label: 'Variant');
