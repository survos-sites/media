 ...
 */
//#[AdminDashboard('/ez-meili', 'admin')]
#[AdminDashboard('/ez', self::MEILI_DASHBOARD_ROUTE)]
class MeiliDashboardController extends AbstractDashboardController
{
    CONST MEILI_DASHBOARD_ROUTE = 'meili_admin';
    ...
    public function configureMenuItems(): iterable
    {
        ...
        //        yield MenuItem::linkToRoute('Examples', 'fa fa-lightbulb', 'admin_examples');
                ...
                yield MenuItem::section('Meili Entities', 'fas fa-folder-open');
