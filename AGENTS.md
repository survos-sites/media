...
Survos applications use bundles that we actively updates as needed. They are located in vendor/survos/*-bundle, and their source is in /home/tac/g/sites/mono/bu/*-bundle.  Don't modify the bundle source without explicit confirmation, since other applications depend on them.  Use the survos bundles when possible, they have been written to support our applications.  In particular

* babel-bundle: store translated string
* sais-bundle: interact with our media server
* import-bundle: analyze, convert and import various formats, using jsonl as an intermediate format.
* jsonl-bundle: read and write jsonl files
* core-bundle: utilities
* state-bundle: wrapper for Symfony workflow-bundle

* museado/data-bundle: manage the pipeline paths for museado projects
